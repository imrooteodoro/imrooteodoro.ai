...
<br><br>
```
As comparações entre neurônios artificiais e
biológicos se encerram aqui. Seria tolice
insistir em comparar um ser humano com uma
máquina para além da abstração do bias — neurônio e
perceptron, córtex e rede neural convolucional.
```
<br><br>
